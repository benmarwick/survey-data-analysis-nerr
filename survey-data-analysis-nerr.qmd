...
As seen in @fig-gender-identity, most of the survey respondents self-identify as female, at `r n_female`. Roughly 8 respondents identify as male, and a few chose not to say. No one wrote in any preferred self-identifier.
...
As seen in @fig-activities, the most common activity for that respondents report doing at the GTM Research Reserve is walking, at `r n_walking`. The 
