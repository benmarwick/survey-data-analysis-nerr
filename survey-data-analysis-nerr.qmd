---
title: "Report on the Guana Tolomato Matanzas National Estuarine Research Reserve Stakeholder Survey"
author:
  - Ben Marwick
  - Aoife Campbell-Smith 
  - Kavya Shrikanth
date: now
format: docx
execute: 
...
The survey included `r ncol(survey_data_q) - 17` questions and received  `r nrow(survey_data_q)` responses.

In this report we summarise the survey responses. The report is organised into four sections: 

- respondent demographics
- activities at the NERR
- awareness of cultural resources at the NERR
- perception of threats to cultural resources at the NERR
...
### Awareness of cultural resources by Age 
...
#| fig-cap: "Perceived Threat to Cultural Resources by Age (most threatening as 1)"
survey_data_q %>% 
  select(starts_with("Age Range"),
...
#| fig-cap: "Perceived Threat to Cultural Resoures by Ethnicity (most threatening as 1)"
survey_data_q %>% 
  select(Ethnicity = starts_with("Ethinicity - Selected Choice"),
         starts_with("What do you see as the biggest threat to cultural resources?"),
         -ends_with("Text")) %>% 
...
#| fig-cap: "Perceived Threat to Cultural Resources by Gender (most threatening as 1)"
survey_data_q %>% 
  select(Gender = starts_with("Gender Identity - Selected Choice"),
         starts_with("What do you see as the biggest threat to cultural resources?"),
         -ends_with("Text")) %>% 
...
#| fig-cap: "Percieved Threat to Cultural Resources by Level of Education (most threatening as 1)"
survey_data_q %>% 
  select(schooling = starts_with("Please select the highest degree or level of schooling you have completed"),
         starts_with("What do you see as the biggest threat to cultural resources?"),
         -ends_with("Text")) %>% 
