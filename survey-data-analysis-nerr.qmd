...
mutate(value = str_squish(value)) %>% 
 mutate(value = fct_relevel(value,
  ...
  ggplot() +
    ...
    coord_flip() +
    facet_wrap( ~ name)
# can we make the n value be in integers instead of decimals?
<<<<<<< HEAD
```
...
=======
# should we say how many people filled out the survey?
>>>>>>> a53449d899e7465f635f0e3e5b8c858c0d11b083
...
Most of the survey respondents self-identify as female, at around 29. Roughly 8 respondents identify as male, and a few chose not to say. No one wrote in any preferred self-identifier.
