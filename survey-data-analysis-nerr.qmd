...
survey_data_q  %>%
  ...
  select(ends_with("Sea Level Rise"),
                   ends_with("Increased and Intensified Storm Events"),
                   ends_with("Flooding"),
                   ends_with("Wave Action"),
                   ends_with("Development"),
                   ends_with("Management Issues"),
                   ends_with("Overuse"),
                   ends_with("Infrastructure (eg. construction of roads"),
                   ends_with("Other (please describe)")) %>% 
  pivot_longer(everything()) %>% 
