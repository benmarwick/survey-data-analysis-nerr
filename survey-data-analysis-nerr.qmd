...
survey_data_q %>% 
 ...
 mutate(value = fct_relevel(value,
  ...
  theme(axis.text.x  = element_text(size = 3))
```
In @fig-ethnicity-awareness-cult-res, since most of the survey respondents identify as Caucasian (non-Hispanic), as seen in @fig-ethnicity-plot , this demographic reports familiarity with cultural resources at the GTM in the greatest quantity. One or more respondents who identify as multiracial report familiarity with all of these cultural resources at the GTM. No respondents who identify as African-American, Asian/Pacific Islander, preferred not to answer or self-identified some other way reported familiarity with canals, remains of industrial activity, or ship hards, docks, and wharves. 
