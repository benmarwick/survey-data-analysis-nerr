...
# plot simple cultural familiarity
  ggplot(simple_survey_data_q_cultural_familiarity ) +
    aes(value, n) +
    geom_col() +
    coord_flip() +
    facet_wrap( ~n_cult_familiar)
```
